...
private val faqItems = listOf(
    ...
    FaqItem(
        ...
        "זו שכבת-על (Overlay) שמאפשרת לכם לשייך תשלום ולהפיק קבלה מבלי לעזוב את האפליקציה שבה אתם משתמשים. היא מופיעה לאחר ששיתפתם עם אוטוקבלה צילום מסך של אישור תשלום."
    ),
    FaqItem(
        "האפליקציה עובדת עם Bit ו-Paybox?",
        "כן. כשמתקבל אישור תשלום ב-Bit או Paybox, לחצו על כפתור השיתוף ובחרו באוטוקבלה. האפליקציה תקרא את פרטי התשלום מתוך התמונה ותציע להפיק קבלה."
    ),
    FaqItem(
        "למה לא מזוהים תשלומים?",
        "ודאו שהפעלתם שיתוף (Share) על צילום מסך של אישור התשלום ובחרתם באוטוקבלה מרשימת האפליקציות. בדקו גם שהרשאת \"הצגה מעל אפליקציות\" מאושרת בהגדרות המכשיר."
    ),
    FaqItem(
